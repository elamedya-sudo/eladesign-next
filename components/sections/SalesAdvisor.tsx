        ...
        {step === questions.length + 2 && (
          <div className="animate-in fade-in slide-in-from-right-8 duration-500 max-w-md mx-auto w-full">
            ...
            <div className="space-y-4">
              ...
              <button 
                onClick={() => alert("Harika! Bu aşamada API bağlantısı devreye girecek.")}
                className="w-full bg-slate-900 text-white py-4 rounded-xl font-bold text-lg hover:bg-slate-800 transition-colors shadow-lg mt-4"
              >
                Raporumu Gönder
              </button>
            </div>
