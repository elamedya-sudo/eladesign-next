...
export const metadata = {
  title: "Profesyonel Google Ads Danışmanlığı ve Reklam Yönetimi",
  description: "Reklam bütçenizi maksimum ROAS (Yatırım Getirisi) hedefiyle yönetiyoruz. Uluslararası ve yerel kampanyalar için veri odaklı Google Ads yönetimi.",
  alternates: {
    canonical: 'https://www.eladesign.org/google-adwords',
  }
};
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://www.eladesign.org/google-adwords"
      }
    ]
  };
        ...
        <div className="relative isolate bg-slate-50 py-24 sm:py-32 overflow-hidden border-b border-slate-200">
          ...
          <div className="max-w-[1440px] mx-auto px-6 lg:px-10 text-center relative z-10">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-[64px] mb-6 leading-tight">
              Profesyonel Google Ads Yönetimiyle <br className="hidden md:block" />
              Bütçenizi <span style={{ color: brandColor }}>Satışa Dönüştürün</span>
            </h1>
