...
export const metadata = {
  title: "GEO ve AIO Optimizasyonu Ajansı | Yapay Zeka SEO",
  ...
  alternates: {
    canonical: 'https://www.eladesign.org/geo-ve-aio-optimizasyonu',
  }
};
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "GEO ve AIO Optimizasyonu",
        "item": "https://www.eladesign.org/geo-ve-aio-optimizasyonu"
      }
    ]
  };
        ...
        <div className="relative isolate bg-slate-900 py-24 sm:py-32 overflow-hidden border-b border-slate-800">
          ...
          <div className="max-w-[1000px] mx-auto px-6 lg:px-10 text-center relative z-10">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl mb-8 leading-tight">
              GEO ve AIO Optimizasyonu ile <br className="hidden md:block" />
              Markanızı <span style={{ color: "#e890d6" }}>Yapay Zekanın</span> Referans Kaynağı Yapın
            </h1>
