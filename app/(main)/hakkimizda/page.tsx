...
export const metadata = {
  title: "Hakkımızda | Kurumsal Web Tasarım ve Yazılım Ajansı",
  description: "2001'den beri faaliyet gösteren Ela Design, web tasarım, özel yazılım ve dijital pazarlama alanında 25 yıllık tecrübesiyle markanıza değer katan köklü bir dijital ajanstır.",
  alternates: {
    canonical: 'https://www.eladesign.org/hakkimizda',
  }
};
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Hakkımızda",
        "item": "https://www.eladesign.org/hakkimizda"
      }
    ]
  };
        ...
        <div className="relative isolate bg-slate-900 py-24 sm:py-32 overflow-hidden">
          ...
          <div className="max-w-[1440px] mx-auto px-6 lg:px-10 text-center">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl mb-6">
              Kurumsal Web Tasarım ve <br className="hidden md:block" />
              <span style={{ color: "#e890d6" }}>Yazılım Ajansı</span>
            </h1>
            <p className="max-w-3xl mx-auto text-[17px] leading-8 text-slate-300 font-light mb-10">
              Sektörün en başından beri (2001) web tasarım ve internet teknolojileri alanında faaliyet gösteren Ela Design, geçici trendlerin ötesinde kalıcı değer üreten köklü bir dijital mühendislik ajansıdır. Çeyrek asırlık tecrübemizle yanınızdayız.
            </p>
          </div>
        </div>
