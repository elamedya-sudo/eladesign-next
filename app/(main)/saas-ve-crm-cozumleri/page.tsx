...
// 1. SAYFAYA ÖZEL METADATA VE CANONICAL (Kopya içerik engeli ve hedef kelime)
export const metadata = {
  title: "Özel SaaS ve CRM Yazılım Firması", // Layout'taki şablonla "Özel SaaS ve CRM Yazılım Firması | Ela Design" olacak.
  description: "İşletmenize özel kodlanmış, akıllı otomasyonlara sahip, yüksek performanslı CRM ve SaaS bulut yazılımları geliştiriyoruz.",
  alternates: {
      ...
      <div className="bg-white min-h-screen pb-24">
        ...
        <div className="relative isolate bg-slate-900 py-24 sm:py-32 overflow-hidden border-b border-slate-800">
          ...
          <div className="max-w-[1440px] mx-auto px-6 lg:px-10 text-center relative z-10">
            ...
            {/* 3. H1 OPTİMİZASYONU (Arama motorlarının en çok değer verdiği başlıkta hedef kelimelerimiz var) */}
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl mb-8 leading-tight">
              Özel SaaS ve CRM Çözümleriyle <br className="hidden md:block" />
              İşletmenizin Dijital Beynini <span style={{ color: "#e890d6" }}>Kodluyoruz</span>
            </h1>
            ...
            <div className="bg-[#933c81] rounded-[40px] p-12 md:p-20 relative overflow-hidden shadow-2xl">
              <div className="relative z-10">
                ...
                <p className="text-white/80 max-w-2xl mx-auto mb-10 text-lg">
                  İster şirket içi süreçlerinizi yönetecek kapalı bir CRM, isterseniz tüm dünyaya satacağınız yeni bir SaaS projesi olsun... Teknik detayları bize bırakın.
                </p>
                <Link 
                  href="/iletisim" 
